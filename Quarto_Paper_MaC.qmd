...
```{r echo=FALSE, message=FALSE, warning=FALSE}
model1 <- lm(under ~ ses + sex + age_num + media + digital + social + interest + extef + intef + ope + incidental, data = merged_data)
summary(model1)
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
model2 <- lm(strate ~ ses + sex + age_num + media + digital + social + interest + extef + intef + ope + incidental, data = merged_data)
summary(model2)
```
